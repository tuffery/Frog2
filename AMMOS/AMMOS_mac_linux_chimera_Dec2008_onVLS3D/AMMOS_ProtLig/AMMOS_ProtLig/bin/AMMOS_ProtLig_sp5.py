...
##########################################
command line = ./AMMOS_ProtLig_sp5.py <ammp.param>
##########################################
...
def preammp_protein_textfile_maker(AMMP_path,protein_file):
    ...
    atoms_path = AMMP_path + '/progs/preammp/' ############################# path /src/ of atoms.sp5 
...
if __name__ == '__main__':
	...
	protein_file = 'protein.ammp'
        ...
        command_process = path_of_AMMP+'progs/Python_scripts/MinProteinLigands_sp5.py param.temp'
