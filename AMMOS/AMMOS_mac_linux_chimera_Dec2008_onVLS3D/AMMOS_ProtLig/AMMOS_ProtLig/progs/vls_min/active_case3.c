...
// All atoms in the sphere will be active, whole rest protein will be inactive
...
int	i = 0, j = 0, k = 0, l = 0, m = 0, 
	...
	active [max_numb_atoms],	
	res_atoms [max_numb_atoms],	// Array for all atoms of the protein
	res_pointers [max_numb_atoms],	// Array for the names of the residue, which atoms fail in the sphere
	pointers [max_numb_atoms],	
	all_sphere [max_numb_atoms];	// Array for the atoms fail in the sphere
...
char	res_buf [line_length],		// Buffer with line_length number of chars - max width of one row
	...
	*res_name [max_numb_atoms],	// Name of the atom  
...
// Determination of the residues, which atoms fails in the shpere
for (i = 0; i < k; i ++) 
{
	div_t point;
...
// Including of all atoms from the residues, failed particularly in the sphere
m = 0;
for (i = 0; i < l; i ++)  
{
