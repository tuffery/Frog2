...
// ------------------------------------------------------------------------------------------------------------
// Re-numbering of ligand atoms after preammp 
...
// Open working files for reading and writting  
	...
	ammp_curr = fopen ("ammp_curr.ammp", "w");	
...
fclose (ammp);			  
fclose (ammp_curr);		  
rename ("ammp_curr.ammp", "input_ligand.ammp"); 
remove ("ammp_curr.ammp");	
