...
###              http://www.vls3d.com                	###
###                                                  	###
###            Script adapted for Frog2 by P. Tuffery   ###
###########################################################
...
##########################################
command line = ./MinMolecules_quickrefine.py <ammp.param>
##########################################
...
def ammp(AMMP_path):
    ...
    ammp_command = AMMP_path + '/bin/ammp_nongraph <' + AMMP_path + '/progs/vls_min/quickmin_ligand.ammp'
...
if __name__ == '__main__':
    ...
    if len(sys.argv)<2 or len(sys.argv)>2:
        ...
        minimized_bank_file = bank[:-5] + '_minimized.mol2'
