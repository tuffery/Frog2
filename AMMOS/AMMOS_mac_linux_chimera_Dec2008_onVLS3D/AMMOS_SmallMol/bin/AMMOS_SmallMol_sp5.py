...
##########################################
command line = ./MinMolecules_sp5.py <ammp.param>
##########################################
...
def preammp_ligand_textfile_maker(AMMP_path):
    ...
    atoms_path = AMMP_path + '/progs/preammp/' ############################# path /src/ of atoms.sp5 k
...
def ammp(AMMP_path):
    ...
    ammp_command = AMMP_path + '/bin/ammp_nongraph <' + AMMP_path + '/progs/vls_min/min_ligand.ammp'
