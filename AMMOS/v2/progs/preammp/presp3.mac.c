...
*   per line type (%s), r,theta,sigma,emin,Z,X,jaa,mass,charge,V,U,hybrid
...
/* now read in the atoms */
	...
	{
	sscanf( work,"%s %f %f %f %f %f %f %f %f %f %f %f %f \n",
...
/* if MAC is defined dictionary[0] = '\0' and the above is skipped */
	ii = 0;
